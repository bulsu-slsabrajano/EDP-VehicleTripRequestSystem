...
public class DriverProfilePanel extends VBox {
    ...
    private final TextField txtLicenseNumber = FxUtil.styledField();
    ...
    private String snapFN, snapMN, snapLN, snapAddr, snapLic, snapUser, snapEmail, snapPwd;
    ...
    private void buildUI() {
        ...
        FxUtil.addFormRow(form, "License Number:",  txtLicenseNumber, y++);
    ...
    public void loadProfile(int userId) {
        ...
        try {
            PreparedStatement ps = conn.prepareStatement(
                ...
                "JOIN Driver d ON u.user_id=d.driver_id WHERE u.user_id=?");
            ps.setInt(1, userId);
            ...
            if (rs.next()) {
                ...
                txtLicenseNumber.setText(nvl(rs.getString("license_number")));
    ...
    private void saveProfile() {
        ...
        try {
            ...
            psD.setString(1, txtLicenseNumber.getText().trim());
    ...
    private void takeSnapshot() {
        ...
        snapLic  = txtLicenseNumber.getText(); snapUser = txtUsername.getText();
        snapEmail= txtEmail.getText();       snapPwd  = txtPassword.getText();
        snapContacts.clear();
    ...
    private void restoreSnapshot() {
        ...
        txtLicenseNumber.setText(snapLic); txtUsername.setText(snapUser);
        txtEmail.setText(snapEmail);    txtPassword.setText(snapPwd);
        contactFields.clear(); contactsBox.getChildren().clear();
